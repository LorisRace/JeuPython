...
class Presentation:
    ...
    def __init__(self):
        ...
        self.MusiqueJeu = pygame.mixer.Sound("sons/04_Stage 1 Vines.mp3")
        self.sonCageOuverte = pygame.mixer.Sound("sons/05_Stage 1 Clear.mp3")
        self.sonChute = pygame.mixer.Sound("sons/18_SFX Hard Landing.mp3")
        self.sonDebut = pygame.mixer.Sound("sons/02 Game Start.mp3")

        # créer la fenêtre avec l'image du fond et le titre

        pygame.display.set_caption("Loris Lefevre-2123-Donkey Kong JR")
    ...
    def jouerSon(self, num):
        if num == 0:
            ...
            pygame.mixer.Sound.play(self.MusiqueJeu)
        elif num == 6:
            pygame.mixer.Sound.play(self.sonCageOuverte)
        elif num == 7:
            pygame.mixer.Sound.play(self.sonChute)
        elif num == 8:
            pygame.mixer.Sound.play(self.sonDebut)
